...
const calculateNextTickPosition = exports.calculateNextTickPosition = (direction, positionObject) => {
    console.log('resolvePlayerMovement.tsx:: in positionCalc!');
    let xLeft = positionObject.xLeft;
    let yTop = positionObject.yTop;
    let speed = positionObject.speed;
